...
Namespace Series_3DStackedAreaChart
    ...
    Public Partial Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs)
            ' Create a new chart.
            Dim stackedArea3DChart As ChartControl = New ChartControl()
            ' Create two series of the StackedArea3D view type.
            Dim series1 As Series = New Series("Series 1", ViewType.StackedArea3D)
            Dim series2 As Series = New Series("Series 2", ViewType.StackedArea3D)
